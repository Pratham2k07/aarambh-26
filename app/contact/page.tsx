      ...
      <div className="space-y-8 relative z-10">
        ...
        <div className="bg-white border-4 border-brand-ink p-8 rounded-lg shadow-[6px_6px_0px_0px_#030404] flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div className="space-y-2">
            <span className="inline-block px-3 py-1 bg-brand-orange text-brand-ink font-mono text-[9px] font-black uppercase tracking-widest border-2 border-brand-ink shadow-comic-sm">
              Venue
            </span>
            ...
            <p className="font-mono text-xs text-brand-ink/75 leading-relaxed font-bold max-w-xl">
              JK Lakshmipat University is located on Ajmer Road, Jaipur, Rajasthan, and is easily accessible via all public transportation networks.
            </p>
          </div>
